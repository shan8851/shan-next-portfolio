---
title: EtherPoll
description: Vote on Ethereum’s spiciest topics.
date: "2025-05-14"
...
<img src="/etherpoll1.png" alt="etherpoll" width={0} height={0} style={{ width: '100%', height: 'auto' }} />

<img src="/etherpoll2.png" alt="etherpoll" width={0} height={0} style={{ width: '100%', height: 'auto' }} />


## The contract

The actual solidity code, which is what I am trying to get better at is pretty minimal, but I wanted something I could just smash out for the first one, but it got me used to writing solidity again without having to look up new things every other line and also working with custom errors, emmiting events to help my UI and a bunch of other stuff. The code is [here](https://github.com/shan8851/EtherPoll) for anybody interested.
