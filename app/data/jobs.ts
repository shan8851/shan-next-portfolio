...
export const jobsData: JobDetails[] = [
  {
    ...
    description: [
      'I recently joined the Aragon App team as a senior engineer in July 2024',
    ],
  },
  {
    ...
    description: [
      'Played a key role in creating and growing a Defi analytics feed, now a platform with 10k+ monthly visitors. Up over 800% since Feb 2022.',
